...
class Controller(ABC):
    ...
    def __init__(self, observation_method=None, subscription_method=None, controllertype="DummyController"):
        ...
        Args:
            observation_method (object, optional): Observation method. Defaults to None.
            subscription_method (object, optional): Subscription method. Defaults to None.
    ...
    # @profile
    def install(self):
        """Install the controller to the vehicle.
        """
        self.vehicle.simulator.set_vehicle_speedmode(self.vehicle.id, 31)
        ...
        if self.vehicle.id == "CAV":
            decel_max = 10
        else:
            decel_max = 4
        self.vehicle.simulator.set_vehicle_emegency_deceleration(self.vehicle.id, decel_max)
...
class BaseController(Controller):
    ...
    def __init__(self, observation_method = Observation, subscription_method=Simulator.subscribe_vehicle_ego, controllertype="BaseController"):
        """Initialize a BaseController object.

        Args:
            observation_method (object, optional): Observation method. Defaults to Observation.
            subscription_method (object, optional): Subscription method. Defaults to Simulator.subscribe_vehicle_ego.
            controllertype (str, optional): Type of the controller. Defaults to "BaseController".
        """
    ...
    def step(self):
        ...
        """        
        self.ego_info = self.vehicle.simulator.get_ego_vehicle(self.vehicle.id, 0)
