...
class IDMController(BaseController):
    ...
    def __init__(self, subscription_method=Simulator.subscribe_vehicle_all_information, controllertype="IDMController"):
        """Initialize the IDM controller.

        Args:
            subscription_method (function, optional): Method to subscribe to the simulator. Defaults to Simulator.subscribe_vehicle_all_information.
            controllertype (str, optional): Type of the controller. Defaults to "IDMController".
        """
