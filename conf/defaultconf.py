...
experiment_config = {}
experiment_config["AV_model"] = "RL" #"IDM", "Surrogate"
experiment_config["server_name"] = "AW3"
# experiment_config["server_name"] = "Greatlakes"
experiment_config["root_folder"] = "output"
...
experiment_config["episode_num"] = 100000
...
if 'NDD_DATA_PATH' in os.environ:
    ndd_data_path = os.environ['NDD_DATA_PATH']
else:
    if print_log_flag:
        print('WARNING: No NDD_DATA_PATH environment variable found, using the current directory as the Data folder')
    ndd_data_path = os.path.abspath('.') + '/source_data/NDE_Data'
# CF_joint_pdf = np.load(ndd_data_path + "/NDD_DATA/CF/New_Optimized_CF_joint_pdf_array.npy")
# presum_list_forward = np.load(ndd_data_path + "/NDD_DATA/Initialization/New_presum_list_forward_vres_0p2.npy")
...
if not LC_smooth_flag:
    SLC_pdf = sparse.load_npz(ndd_data_path + "/NDD_DATA/LC/10119_10630_SLC_pdf_smoothed.npz").todense()
    DLC_pdf = sparse.load_npz(ndd_data_path + "/NDD_DATA/LC/10119_10630_DLC_pdf_smoothed.npz").todense()
    OL_pdf = sparse.load_npz(ndd_data_path + "/NDD_DATA/LC/10106_10620_OL_pdf_smoothed.npz").todense()
    CI_pdf = sparse.load_npz(ndd_data_path + "/NDD_DATA/LC/10119_10630_CI_pdf_smoothed.npz").todense()
else:
